...
public class Operator {
    ...
    public Operator() {
        ...
        jsonLogicHandler.addOperation(new dev.openfeature.contrib.providers.flagd.resolver.process.targeting.Fractional());
        jsonLogicHandler.addOperation(new dev.openfeature.contrib.providers.flagd.resolver.process.targeting.SemVer());
        jsonLogicHandler.addOperation(new dev.openfeature.contrib.providers.flagd.resolver.process.targeting.StringComp(dev.openfeature.contrib.providers.flagd.resolver.process.targeting.StringComp.Type.STARTS_WITH));
        jsonLogicHandler.addOperation(new dev.openfeature.contrib.providers.flagd.resolver.process.targeting.StringComp(dev.openfeature.contrib.providers.flagd.resolver.process.targeting.StringComp.Type.ENDS_WITH));
    }
    ...
    public Object apply(final String flagKey, final String targetingRule, final EvaluationContext ctx)
            throws dev.openfeature.contrib.providers.flagd.resolver.process.targeting.TargetingRuleException {
